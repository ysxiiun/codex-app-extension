...
`python3 .codex/hooks/easy_coding_state.py claim-task --session-file <P> --task-id <task-id> --agent <agent-id>`.
...
`python3 .codex/hooks/easy_coding_state.py create-task --session-file <P> --task-id <MM-DD-short-name> --type <feature|bugfix|refactor|perf|doc|analysis|report|workflow> --title "<one-line summary>" --agent <agent-id> --no-set-current`.
...
`python3 .codex/hooks/easy_coding_state.py set-confirm-mode --session-file <P> --mode <approve|guard|lite|auto> --agent <agent-id>`.

Restore project configuration through:
`python3 .codex/hooks/easy_coding_state.py clear-confirm-mode --session-file <P> --agent <agent-id>`.
