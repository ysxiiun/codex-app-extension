...
`python3 .codex/hooks/easy_coding_state.py disable-harness --session-file <P> --agent <agent-id>`
...
`python3 .codex/hooks/easy_coding_state.py enable-harness --session-file <P> --agent <agent-id>`
