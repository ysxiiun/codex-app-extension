...
2. Otherwise run
   `python3 .codex/hooks/easy_coding_state.py snapshot --agent <agent-id>`
...
gaps were fixed), run
`python3 .codex/hooks/easy_coding_state.py project-init-complete --session-file <P> --agent <agent-id>`.
