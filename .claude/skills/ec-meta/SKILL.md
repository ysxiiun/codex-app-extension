---
name: ec-meta
description: Understand and locally customize the Easy Coding harness installation. Use when the user runs /ec-meta, asks how the harness works, wants to inspect installed platform files, or wants a local customization strategy. Reads references/ on demand. Never touches runtime task data.
---
