...
`python3 .claude/hooks/easy_coding_state.py memory-new-id --session-file <P> --agent <agent-id>`.
...
`python3 .claude/hooks/easy_coding_state.py memory-short-complete --session-file <P> --file "<relative-short-memory-path>" --agent <agent-id>`.
...
1. After Step 1 is checkpointed, call
   `python3 .claude/hooks/easy_coding_state.py memory-instruction --session-file <P>`.
...
`python3 .claude/hooks/easy_coding_state.py memory-complete --session-file <P> --action <no-op|distill> --agent <agent-id>`.
...
`python3 .claude/hooks/easy_coding_state.py auto-transition --session-file <P> --stage COMPLETE --agent <agent-id>`.
