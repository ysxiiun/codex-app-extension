...
You MUST dispatch sub-agents using Agent tool for every unit, whatever the
...
3. Dispatch according to strategy, via Agent tool:
   ...
   Platform spawn rule: Use the Agent tool with run_in_background when useful; use isolation: "worktree" for parallel file edits.
