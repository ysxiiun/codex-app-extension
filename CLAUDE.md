...
- Workflow state operations go through `.claude/hooks/easy_coding_state.py`;
...
- Workflow session files live at `.easy-coding/sessions/`; the CLI only installs files and
