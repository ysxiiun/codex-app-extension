...
它的目标不是替代 Codex App，也不是修改应用包体，而是在运行时为 Codex App 补充一些更贴近实际工作流的体验增强。当前版本主要解决宽屏空间利用、macOS 全屏遮挡、中文输入法回车误发送等问题；后续也可以继续承载更多 Codex App 的增强注入能力。
